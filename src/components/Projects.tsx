  ...
  const publications = [
    {
      ...
      image: '/How-to-Prepare-Survive-and-Thrive.png',
    ...
    },
    {
      ...
      image: '/Decoding-statutory-deductions-in-Kenya.png',
    ...
    },
    {
      ...
      image: '/Employment-Models-in-Kenya.png',
    ...
    },
    {
      ...
      image: '/ElevateHR-vs-Microsoft-Excel-for-HR-and-Payroll-Management.png',
    ...
    },
    {
      ...
      image: '/New-Payroll-Tax-Changes-in-Kenya-2025.png',
    ...
    },
    {
      ...
      image: '/Income-Tax-Return-Season.png',
            ...
            <div key={index} className="project-card">
              <div>
                ...
                <a 
                  ...
                  className="block aspect-video bg-secondary rounded-lg overflow-hidden shadow-md mb-4 group"
                >
                  {project.image ? (
                    <img
                      src={project.image}
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-muted to-secondary transition-opacity duration-300 group-hover:opacity-80">
                      <div className="text-center p-4">
                        <span className="font-serif text-xl sm:text-2xl font-bold text-muted-foreground/40">
                          Publication
                        </span>
                ...
                >
                  <h3>Read Article</h3><ExternalLink size={12}/>
                </a>
              </div>
            </div>
          ))}
